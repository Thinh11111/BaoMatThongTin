 ...
 */
public class fDeDes extends javax.swing.JFrame {
    private int mode;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fDeDes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
